 ...
 * @author DANIEL_VE160
 */
public class frmFacil4 extends javax.swing.JInternalFrame {
    ...
    //E SETA O VALOR DA VARIAL CHANCES
    public void recebeChance4(int r){
        chances = r;
    }
    public frmFacil4() {
        initComponents();
    ...
    private void visuaImage(){
        lblTemChance4.setText(""+chances);
        lblVisualiza.setIcon(null);
        lblVisualiza.setText("Resposta Errada");
        mensagemTela();
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest4p.jpg")));
    ...
    public void mensagemTela(){
        ...
        switch(chances){
            ...
            case 0:
                ...
                frmJogar.play2("/audio/errou");
                fim.lblPontos.setText("30");
                fim.lblQuestao.setText("QUESTÃO 4");  
    ...
    private void initComponents() {
        ...
        lblTemChance4 = new javax.swing.JLabel();
        ...
        txtPergunta.setText(" O corpo humano é composto de");
        ...
        jtxtpC1.setText("Seria bom todas as escolas (em geral) terem noções básicas de primeiros socorros? por quê");
        jtxtpC1.setFocusable(false);
        jcpPergunta.setViewportView(jtxtpC1);

        jDesktopPane4.add(jcpPergunta);
        jcpPergunta.setBounds(90, 20, 570, 60);

        btnOk1.setFont(new java.awt.Font("Poetsen One", 0, 24)); // NOI18N
        btnOk1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btnL4.png"))); // NOI18N
        ...
        btnOk1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btn4.png"))); // NOI18N
        jDesktopPane4.add(btnOk1);
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest4p.jpg"))); // NOI18N
        ...
        jDesktopPane4.add(lblChances);
        lblChances.setBounds(1010, 550, 180, 60);

        lblTemChance4.setFont(new java.awt.Font("Poetsen One", 0, 33)); // NOI18N
        lblTemChance4.setForeground(new java.awt.Color(204, 0, 51));
        lblTemChance4.setText("3");
        jDesktopPane4.add(lblTemChance4);
        lblTemChance4.setBounds(1170, 550, 50, 60);
        ...
        jDesktopPane4.add(lblTotChance);
        ...
        jDesktopPane4.add(lblCabecalho);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest4r.jpg")));
                ...
                frmFacil5 f5 = new frmFacil5();
                jDesktopPane4.add(f5);//ABRINDO O PROXIMO FRM
                f5.setVisible(true);//DEIXANDO O FRM VISIVEL
                
                f5.recebeChance5(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                f5.lblTemChance5.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                       
            }else{
                contador(1);
                switch(chances){
                    case 0: 
                        visuaImage();
                        jDesktopPane4.add(fim);
                        fim.setVisible(true);
                        break;
                    default:
                        visuaImage();
    ...
    public javax.swing.JLabel lblTemChance4;
