 ...
 * @author DANIEL_VE160
 */
public class frmFacil5 extends javax.swing.JInternalFrame {
    ...
    private void visuaImage(){
        ...
        mensagemTela();
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest5p.jpg")));
    ...
    private void initComponents() {
        ...
        txtPergunta.setText(" Qual é a média de temperatura do corpo humano?");
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest5p.jpg"))); // NOI18N
        ...
        lblTemChance5.setText("3");
        jDesktopPane5.add(lblTemChance5);
        ...
        jDesktopPane5.add(lblTotChance);
        ...
        jDesktopPane5.add(lblCabecalho);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest5r.jpg")));
                ...
                frmFacil6 f6 = new frmFacil6();
                jDesktopPane5.add(f6);//ABRINDO O PROXIMO FRM
                f6.setVisible(true);//DEIXANDO O FRM VISIVEL
                
                f6.recebeChance6(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                f6.lblTemChance6.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                       
            }else{
                contador(1);
                switch(chances){
                    case 0: 
                        visuaImage(); 
                        jDesktopPane5.add(fim);
                        fim.setVisible(true);
                        break;
                    default:
                        visuaImage();
