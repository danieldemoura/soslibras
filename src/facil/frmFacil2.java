 ...
 * @author DANIEL_VE160
 */
public class frmFacil2 extends javax.swing.JInternalFrame {
    ...
    //E SETA O VALOR DA VARIAL CHANCES
    public void recebeChance2(int r){
        chances = r;
    }
    public frmFacil2() {
        initComponents();
    ...
    public void mensagemTela(){
        ...
        switch(chances){
            ...
            case 0:
                ...
                frmJogar.play2("/audio/errou");
                fim.lblPontos.setText("10");
                fim.lblQuestao.setText("QUESTÃO 2");  
                fim.lblTemChance.setText("0");
                fim.lblTotChance.setText("3");                  
                break;                
        }// fim do switch
    ...
    private void initComponents() {
        ...
        lblTemChance2 = new javax.swing.JLabel();
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest2p.jpg"))); // NOI18N
        ...
        txtPergunta.setFont(new java.awt.Font("SansSerif", 0, 20)); // NOI18N
        txtPergunta.setForeground(new java.awt.Color(255, 255, 255));
        txtPergunta.setText("O que basicamente devemos saber sobre primeiros socorros?");
        ...
        jDesktopPane2.add(txtConfiRes);
        txtConfiRes.setBounds(750, 380, 310, 60);

        btnNumDois.setFont(new java.awt.Font("Poetsen One", 0, 24)); // NOI18N
        btnNumDois.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btnL2.png"))); // NOI18N
        btnNumDois.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        btnNumDois.setContentAreaFilled(false);
        btnNumDois.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnNumDois.setFocusable(false);
        btnNumDois.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btn2.png"))); // NOI18N
        jDesktopPane2.add(btnNumDois);
        btnNumDois.setBounds(20, 20, 70, 60);
        ...
        jtxtpC1.setText("O que basicamente devemos saber sobre primeiros socorros?");
        jtxtpC1.setFocusable(false);
        jcpPergunta.setViewportView(jtxtpC1);

        jDesktopPane2.add(jcpPergunta);
        ...
        jDesktopPane2.add(lblChances);
        lblChances.setBounds(1010, 550, 180, 60);

        lblTemChance2.setFont(new java.awt.Font("Poetsen One", 0, 33)); // NOI18N
        lblTemChance2.setForeground(new java.awt.Color(204, 0, 51));
        lblTemChance2.setText("3");
        jDesktopPane2.add(lblTemChance2);
        lblTemChance2.setBounds(1170, 550, 50, 60);
        ...
        jDesktopPane2.add(lblTotChance);
        ...
        jDesktopPane2.add(lblCabecalho);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest2r.jpg")));
                ...
                frmFacil3 f3 = new frmFacil3();
                jDesktopPane2.add(f3);//ABRINDO O PROXIMO FRM
                f3.setVisible(true);//DEIXANDO O FRM VISIVEl

                f3.recebeChance3(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                f3.lblTemChance3.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES
            }else{
                contador(1);
                switch(chances){
                    case 0:
                    visuaImage();
                    jDesktopPane2.add(fim);
                    fim.setVisible(true);
                    break;
                    default:
                    visuaImage();
    ...
    public javax.swing.JLabel lblTemChance2;
