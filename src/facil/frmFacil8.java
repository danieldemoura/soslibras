 ...
 * @author DANIEL_VE160
 */
public class frmFacil8 extends javax.swing.JInternalFrame {
    ...
    //E SETA O VALOR DA VARIAL CHANCES
    public void recebeChance8(int r){
        chances = r;
    }
    public frmFacil8() {
        initComponents();
    ...
    private void visuaImage(){
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest8p.jpg")));
    ...
    public void mensagemTela(){
        ...
        switch(chances){
            ...
            case 0:
                ...
                frmJogar.play2("/audio/errou");
                fim.lblPontos.setText("70");
                fim.lblQuestao.setText("QUESTÃO 8");  
    ...
    private void initComponents() {
        ...
        jcpC = new javax.swing.JScrollPane();
        ...
        lblTemChance8 = new javax.swing.JLabel();
        ...
        jcpPergunta.setBorder(null);

        jEditorPane2.setBackground(new java.awt.Color(0, 102, 102));
        jEditorPane2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        jEditorPane2.setFont(new java.awt.Font("SansSerif", 0, 20)); // NOI18N
        jEditorPane2.setForeground(new java.awt.Color(255, 255, 255));
        jEditorPane2.setText("você  pisou  em  um  prego  que  penetrou bem fundo no pé  A  ferida sangra pouco. O que Você Faz?");
        jcpPergunta.setViewportView(jEditorPane2);

        jDesktopPane8.add(jcpPergunta);
        jcpPergunta.setBounds(90, 20, 570, 60);

        jcpC.setBorder(null);

        jEditorPane3.setBackground(new java.awt.Color(0, 102, 102));
        jEditorPane3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        jEditorPane3.setFont(new java.awt.Font("SansSerif", 0, 21)); // NOI18N
        jEditorPane3.setForeground(new java.awt.Color(255, 255, 255));
        jEditorPane3.setText("Deixa o prego na ferida, põe uma atadura  e vá  para  o pronto socorro");
        jcpC.setViewportView(jEditorPane3);

        jDesktopPane8.add(jcpC);
        jcpC.setBounds(750, 170, 530, 60);
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest8p.jpg"))); // NOI18N
        ...
        jDesktopPane8.add(btnE);
        btnE.setBounds(680, 310, 70, 60);

        btnOk1.setFont(new java.awt.Font("Poetsen One", 0, 24)); // NOI18N
        btnOk1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btnL8.png"))); // NOI18N
        ...
        btnOk1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btn8.png"))); // NOI18N
        jDesktopPane8.add(btnOk1);
        ...
        lblPontos.setText("70");
        jDesktopPane8.add(lblPontos);
        ...
        jDesktopPane8.add(lblChances);
        lblChances.setBounds(1010, 550, 180, 60);

        lblTemChance8.setFont(new java.awt.Font("Poetsen One", 0, 33)); // NOI18N
        lblTemChance8.setForeground(new java.awt.Color(204, 0, 51));
        lblTemChance8.setText("3");
        jDesktopPane8.add(lblTemChance8);
        lblTemChance8.setBounds(1170, 550, 50, 60);

        jLabel2.setFont(new java.awt.Font("Poetsen One", 0, 33)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 204, 102));
        jLabel2.setText("/");
        jDesktopPane8.add(jLabel2);
        ...
        jDesktopPane8.add(lblCabecalho);
        ...
        jDesktopPane8.add(lblFundo);
        lblFundo.setBounds(0, 0, 1380, 700);

        getContentPane().add(jDesktopPane8);
        jDesktopPane8.setBounds(0, 0, 1380, 700);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest8r.jpg")));
                lblPontos.setText("80");                     
                ...
                frmFacilNove f9 = new frmFacilNove();
                jDesktopPane8.add(f9);//ABRINDO O PROXIMO FRM
                f9.setVisible(true);//DEIXANDO O FRM VISIVEL
                
                f9.recebeChance9(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                f9.lblTemChance9.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                      
            }else{
                contador(1);
                switch(chances){
                    case 0: 
                        visuaImage();
                        jDesktopPane8.add(fim);
                        fim.setVisible(true);
                        break;
                    default:
                        visuaImage();
          ...
          JOptionPane.showMessageDialog(null, "Por favor selecione uma questão"); 
        }
    ...
    private javax.swing.JScrollPane jcpC;
    ...
    public javax.swing.JLabel lblTemChance8;
