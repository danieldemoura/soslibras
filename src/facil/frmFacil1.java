 ...
 * @author DANIEL_VE160
 */
public class frmFacil1 extends javax.swing.JInternalFrame {
    
    /**
     * Creates new form frmQuizTela
     */
    private  int chances = 3;//variavel que contem o numero chances 
    private boolean passou = false;//variavel que mostra se o botão é o certo ou não
    private boolean selecao = false;//variavel que mostra se o botão esta selecionado ou não
    ...
    private void visuaImage(){
        lblTemChance.setText(""+chances);
        lblVisualiza.setIcon(null);
        lblVisualiza.setText("Resposta Errada");
        mensagemTela();
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest1p.jpg")));
    ...
    public void mensagemTela(){
        ...
        switch(chances){
            ...
            case 0:
                ...
                frmJogar.play2("/audio/errou");
                fim.lblPontos.setText("0");
                fim.lblQuestao.setText("QUESTÃO 1");  
    ...
    private void initComponents() {
        ...
        txtPergunta.setText(" O que mais causa acidentes nas residências?");
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest1p.jpg"))); // NOI18N
        ...
        txtA.setText(" As crianças quando estão brincando ou brigando");
        ...
        txtB.setText(" Os animais de estimação");
        ...
        txtC.setText(" Queda de pessoas idosas");
        ...
        txtD.setText(" Os eletrodomésticos");
        ...
        txtE.setText(" Os móveis em péssimo estado de conservação");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        // BOTÃO OK
        if(selecao == true){//se o botão estiver selecionado|selecao==true execute
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest1r.jpg")));
                ...
                frmFacil2 f2 = new frmFacil2();
                jDesktopPane1.add(f2);
                f2.setVisible(true);
                
                f2.recebeChance2(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                f2.lblTemChance2.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                
            }else{
                contador(1);
                switch(chances){
                    case 0: 
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        //QUANDO A TELA FOR ABERTA EXECUTE
