 ...
 * @author DANIEL_VE160
 */
public class frmFacilNove extends javax.swing.JInternalFrame {
    ...
    //E SETA O VALOR DA VARIAL CHANCES
    public void recebeChance9(int r){
        chances = r;
    }
    ...
    private void visuaImage(){
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest9p.jpg")));
    ...
    public void mensagemTela(){
        ...
        switch(chances){
            ...
            case 0:
                ...
                frmJogar.play2("/audio/errou");
                fim.lblPontos.setText("80");
                fim.lblQuestao.setText("QUESTÃO 9");  
    ...
    private void initComponents() {
        ...
        lblTemChance9 = new javax.swing.JLabel();
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest9p.jpg"))); // NOI18N
        ...
        jDesktopPane9.add(btnE);
        btnE.setBounds(680, 310, 70, 60);

        btnOk1.setFont(new java.awt.Font("Poetsen One", 0, 24)); // NOI18N
        btnOk1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btnL9.png"))); // NOI18N
        ...
        btnOk1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btn9.png"))); // NOI18N
        jDesktopPane9.add(btnOk1);
        ...
        jDesktopPane9.add(btnOk);
        btnOk.setBounds(680, 380, 70, 60);

        txtA1.setEditable(false);
        txtA1.setBackground(new java.awt.Color(0, 102, 102));
        txtA1.setFont(new java.awt.Font("SansSerif", 0, 22)); // NOI18N
        txtA1.setForeground(new java.awt.Color(255, 255, 255));
        txtA1.setText(" O que se deve fazer em caso de envenenamento?");
        txtA1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtA1.setFocusable(false);
        jDesktopPane9.add(txtA1);
        txtA1.setBounds(90, 20, 570, 60);
        ...
        jDesktopPane9.add(lblChances);
        lblChances.setBounds(1010, 550, 180, 60);

        lblTemChance9.setFont(new java.awt.Font("Poetsen One", 0, 33)); // NOI18N
        lblTemChance9.setForeground(new java.awt.Color(204, 0, 51));
        lblTemChance9.setText("3");
        jDesktopPane9.add(lblTemChance9);
        lblTemChance9.setBounds(1170, 550, 50, 60);

        jLabel2.setFont(new java.awt.Font("Poetsen One", 0, 33)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 204, 102));
        jLabel2.setText("/");
        jDesktopPane9.add(jLabel2);
        ...
        jDesktopPane9.add(lblCabecalho);
        ...
        jDesktopPane9.add(lblFundo);
        lblFundo.setBounds(0, 0, 1380, 700);

        getContentPane().add(jDesktopPane9);
        jDesktopPane9.setBounds(0, 0, 1380, 700);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest9r.jpg")));
                ...
                frmFacil10 f10 = new frmFacil10();
                jDesktopPane9.add(f10);//ABRINDO O PROXIMO FRM
                f10.setVisible(true);//DEIXANDO O FRM VISIVEL
                
                f10.recebeChance10(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                f10.lblTemChance10.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                      
            }else{
                contador(1);
                switch(chances){
                    case 0: 
                        visuaImage();
                        jDesktopPane9.add(fim);
                        fim.setVisible(true);
                        break;
                    default:
                        visuaImage();
    ...
    public javax.swing.JLabel lblTemChance9;
