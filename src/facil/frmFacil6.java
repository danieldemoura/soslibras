 ...
 * @author DANIEL_VE160
 */
public class frmFacil6 extends javax.swing.JInternalFrame {
    ...
    //E SETA O VALOR DA VARIAL CHANCES
    public void recebeChance6(int r){
        chances = r;
    }
    public frmFacil6() {
        initComponents();
    ...
    private void visuaImage(){
        lblTemChance6.setText(""+chances);
        lblVisualiza.setIcon(null);
        lblVisualiza.setText("Resposta Errada");
        mensagemTela();
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest6p.jpg")));
    ...
    public void mensagemTela(){
        ...
        switch(chances){
            ...
            case 0:
                ...
                frmJogar.play2("/audio/errou");
                fim.lblPontos.setText("50");
                fim.lblQuestao.setText("QUESTÃO 6");  
    ...
    private void initComponents() {
        ...
        lblTemChance6 = new javax.swing.JLabel();
        ...
        txtPergunta.setText(" O que fazer em caso de sangramento pelo nariz?");
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest6p.jpg"))); // NOI18N
        ...
        jDesktopPane6.add(btnE);
        btnE.setBounds(680, 310, 70, 60);

        btnOk1.setFont(new java.awt.Font("Poetsen One", 0, 24)); // NOI18N
        btnOk1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btnL6.png"))); // NOI18N
        ...
        btnOk1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btn6.png"))); // NOI18N
        jDesktopPane6.add(btnOk1);
        ...
        jDesktopPane6.add(lblChances);
        lblChances.setBounds(1010, 550, 180, 60);

        lblTemChance6.setFont(new java.awt.Font("Poetsen One", 0, 33)); // NOI18N
        lblTemChance6.setForeground(new java.awt.Color(204, 0, 51));
        lblTemChance6.setText("3");
        jDesktopPane6.add(lblTemChance6);
        lblTemChance6.setBounds(1170, 550, 50, 60);

        jLabel2.setFont(new java.awt.Font("Poetsen One", 0, 33)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 204, 102));
        jLabel2.setText("/");
        jDesktopPane6.add(jLabel2);
        ...
        jDesktopPane6.add(lblCabecalho);
        ...
        jDesktopPane6.add(lblFundo);
        lblFundo.setBounds(0, 0, 1380, 700);

        getContentPane().add(jDesktopPane6);
        jDesktopPane6.setBounds(0, 0, 1380, 700);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        // BOTÃO OK
        if(selecao == true){
            if (passou == true && chances != 0) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest6r.jpg")));
                ...
                frmFacil7 f7 = new frmFacil7();
                jDesktopPane6.add(f7);//ABRINDO O PROXIMO FRM
                f7.setVisible(true);//DEIXANDO O FRM VISIVEL
                
                f7.recebeChance7(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                f7.lblTemChance7.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                      
            }else{
                contador(1);
                switch(chances){
                    case 0: 
                        visuaImage();
                        jDesktopPane6.add(fim);
                        fim.setVisible(true);
                        break;
                    default:
                        visuaImage();
    ...
    public javax.swing.JLabel lblTemChance6;
