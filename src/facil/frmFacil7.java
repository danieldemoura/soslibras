 ...
 * @author DANIEL_VE160
 */
public class frmFacil7 extends javax.swing.JInternalFrame {
    ...
    private void visuaImage(){
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest7p.jpg")));
    ...
    private void initComponents() {
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest7p.jpg"))); // NOI18N
        ...
        lblTemChance7.setText("3");
        jDesktopPane7.add(lblTemChance7);
        ...
        jDesktopPane7.add(lblTotChance);
        ...
        jDesktopPane7.add(lblCabecalho);
        ...
        jDesktopPane7.add(lblFundo);
        lblFundo.setBounds(0, 0, 1380, 700);

        getContentPane().add(jDesktopPane7);
        jDesktopPane7.setBounds(0, 0, 1380, 700);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/quest7r.jpg")));
                ...
                frmFacil8 f8 = new frmFacil8();
                jDesktopPane7.add(f8);//ABRINDO O PROXIMO FRM
                f8.setVisible(true);//DEIXANDO O FRM VISIVEL
                
                f8.recebeChance8(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                f8.lblTemChance8.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                      
            }else{
                contador(1);
                switch(chances){
                    case 0: 
                        visuaImage();
                        jDesktopPane7.add(fim);
                        fim.setVisible(true);
                        break;
                    default:
                        visuaImage();
