 ...
 * @author DANIEL_VE160
 */
public class frmMedio7 extends javax.swing.JInternalFrame {
    ...
    //E SETA O VALOR DA VARIAL CHANCES
    public void recebeChance7(int r){
        chances = r;
    }
    public frmMedio7() {
        initComponents();
    ...
    private void visuaImage(){
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM7p.jpg")));
    ...
    public void mensagemTela(){
        ...
        switch(chances){
            ...
            case 0:
                ...
                frmJogar.play2("/audio/errou");
                fim.lblPontos.setText("60");
                fim.lblQuestao.setText("QUESTÃO 7");  
    ...
    private void initComponents() {
        ...
        txtE1.setText(" Ao observar uma pessoa tendo convulsões, deve-se?");
        txtE1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txtE1.setFocusable(false);
        jDesktopPane1.add(txtE1);
        txtE1.setBounds(90, 20, 570, 60);
        ...
        jTextPane4.setFont(new java.awt.Font("SansSerif", 0, 20)); // NOI18N
        jTextPane4.setForeground(new java.awt.Color(255, 255, 255));
        jTextPane4.setText("Proteger a cabeça contra traumas e vira-la de lado se estiver vomitando");
        ...
        jscpE.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)));
        jscpE.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        jscpE.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);

        jTextPane6.setEditable(false);
        jTextPane6.setBackground(new java.awt.Color(0, 102, 102));
        jTextPane6.setBorder(null);
        jTextPane6.setFont(new java.awt.Font("SansSerif", 0, 20)); // NOI18N
        jTextPane6.setForeground(new java.awt.Color(255, 255, 255));
        jTextPane6.setText("Abrir a boca da mesma e colocar um pano entre seus dentes");
        jTextPane6.setFocusable(false);
        jscpE.setViewportView(jTextPane6);

        jDesktopPane1.add(jscpE);
        jscpE.setBounds(750, 310, 530, 60);
        ...
        lblTemChance7.setFont(new java.awt.Font("Poetsen One", 0, 33)); // NOI18N
        lblTemChance7.setForeground(new java.awt.Color(204, 0, 51));
        lblTemChance7.setText("2");
        jDesktopPane1.add(lblTemChance7);
        lblTemChance7.setBounds(1170, 550, 50, 60);
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM7p.jpg"))); // NOI18N
        ...
        btnOk1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btnL7.png"))); // NOI18N
        ...
        btnOk1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btn7.png"))); // NOI18N
        ...
        txtA.setText(" Pedir ajuda e tentar imobiliza-la");
        ...
        txtB.setText(" Não interferir, pois, isto é espontâneo");
        ...
        txtD.setText(" Abrir as vestes para melhor respiração");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM7r.jpg")));
                ...
                frmMedio8 m8 = new frmMedio8();
                jDesktopPane1.add(m8);
                m8.setVisible(true);
                
                m8.recebeChance8(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                m8.lblTemChance8.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                
            }else{
                contador(1);
                switch(chances){
                    case 0: 
    ...
    private javax.swing.JScrollPane jscpE;
    ...
    public javax.swing.JLabel lblTemChance7;
