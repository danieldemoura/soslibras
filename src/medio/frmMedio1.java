 ...
 * @author DANIEL_VE160
 */
public class frmMedio1 extends javax.swing.JInternalFrame {
    ...
    private void visuaImage(){
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM1p.jpg")));
    ...
    private void initComponents() {
        ...
        txtPergunta.setText(" Em que data é comemorado o dia dos Bombeiros?");
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM1p.jpg"))); // NOI18N
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM1r.jpg")));
                ...
                frmMedio2 m2 = new frmMedio2();
                jDesktopPane1.add(m2);
                m2.setVisible(true);
                
                m2.recebeChance2(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                m2.lblTemChance2.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                
            }else{
                contador(1);
                switch(chances){
                    case 0: 
