 ...
 * @author DANIEL_VE160
 */
public class frmMedio9 extends javax.swing.JInternalFrame {
    ...
    private void visuaImage(){
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM9p.jpg")));
    ...
    private void initComponents() {
        ...
        lblTemChance9.setText("2");
        jDesktopPane1.add(lblTemChance9);
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM9p.jpg"))); // NOI18N
        ...
        txtA.setText(" Acidentes com trânsito e quedas de motocicletas");
        ...
        txtB.setText(" Quedas em locais impróprios");
        ...
        txtC.setText(" Picadas de animais peçonhentos");
        ...
        txtD.setText(" Acidentes com Brinquedos infantis");
        ...
        txtE.setText(" Afogamentos em piscinas, rios, represas e praias");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM9r.jpg")));
                ...
                frmMedio10 m10 = new frmMedio10();
                jDesktopPane1.add(m10);
                m10.setVisible(true);
                
                m10.recebeChance10(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                m10.lblTemChance10.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                
            }else{
                contador(1);
                switch(chances){
                    case 0: 
