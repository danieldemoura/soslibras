 ...
 * @author DANIEL_VE160
 */
public class frmMedio2 extends javax.swing.JInternalFrame {
    ...
    private void visuaImage(){
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM2p.jpg")));
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("Num acidente de trânsito, em primeiro lugar, deve-se avaliar as vias aéreas e estabilizar a coluna cervical (pescoço) da vítima, imobilizando-a. Esta ação é muito importante porque?");
        ...
        lblTemChance2.setText("2");
        jDesktopPane1.add(lblTemChance2);
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM2p.jpg"))); // NOI18N
        ...
        btnOk1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btnL2.png"))); // NOI18N
        ...
        btnOk1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/btn2.png"))); // NOI18N
        ...
        txtA.setText(" A cabeça despenca após o acidente");
        ...
        txtB.setText(" Segurando a vítima pelo pescoço ela não se debate");
        ...
        txtC.setText(" O pescoço é de fácil alcance, não tendo que tirar roupas");
        ...
        txtD.setText(" Evita que a pessoa fique paralítica");
        ...
        txtE.setText(" Evita que a vítima se vire para ver o que fazemos");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM2r.jpg")));
                ...
                frmMedio3 m3 = new frmMedio3();
                jDesktopPane1.add(m3);
                m3.setVisible(true);
                
                m3.recebeChance3(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                m3.lblTemChance3.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                
            }else{
                contador(1);
                switch(chances){
                    case 0: 
