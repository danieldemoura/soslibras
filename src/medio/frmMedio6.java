 ...
 * @author DANIEL_VE160
 */
public class frmMedio6 extends javax.swing.JInternalFrame {
    ...
    private void visuaImage(){
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM6p.jpg")));
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("Uma pessoa esta caída na rua após atropelamento. O que fazer?");
        ...
        lblTemChance6.setText("2");
        jDesktopPane1.add(lblTemChance6);
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM6p.jpg"))); // NOI18N
        ...
        txtA.setText(" Iniciar o atendimento, no local");
        ...
        txtB.setText(" Anotar a placa do veiculo infrator");
        ...
        txtC.setText(" Sinalizar o local do acidente para evitar outro");
        ...
        txtD.setText(" Remover a pessoa para a calçada");
        ...
        txtE.setText(" Tentar contato com algum parente da vitima");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questM6r.jpg")));
                ...
                frmMedio7 m7 = new frmMedio7();
                jDesktopPane1.add(m7);
                m7.setVisible(true);
                
                m7.recebeChance7(chances);//PASSANDO PARA A VARIAL CHANCES DO PROXIMO FRM QUANTAS CHANCES AINDA TEM
                m7.lblTemChance7.setText(""+chances);//PASSANDO PARA A LBL DO PROXIMO FRM O TEXTO DE CHANCES                
            }else{
                contador(1);
                switch(chances){
                    case 0: 
