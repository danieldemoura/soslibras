 ...
 * @author DANIEL_VE160
 */
public class frmDificil6 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtPergunta.setFont(new java.awt.Font("SansSerif", 0, 21)); // NOI18N
        txtPergunta.setForeground(new java.awt.Color(255, 255, 255));
        txtPergunta.setText(" Caso uma vitima esteja pegando fogo, o que fazer?");
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questD6p.jpg"))); // NOI18N
        ...
        txtA.setText(" Apagar com o extintor");
        ...
        txtB.setText(" Tentar tirar a roupa da mesma");
        ...
        txtD.setText(" Usar um cobertor para abafar as chamas");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questD6r.jpg")));
                ...
                frmDificil7 D7 = new frmDificil7();
                jDesktopPane1.add(D7);
                D7.setVisible(true);
