 ...
 * @author DANIEL_VE160
 */
public class frmDificil7 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtPergunta.setText(" Como estancar sangramentos de uma vitima?");
        ...
        jTextPane3.setText("Utilizar um pano seco e limpo fazendo compressões no local");
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questD7p.jpg"))); // NOI18N
        ...
        txtA.setText(" Dar qualquer tipo de liquido para a mesma");
        ...
        txtB.setText(" Tentar sugar o sangramento, até a parada do mesmo");
        ...
        txtD.setText(" Transpor o sangue para outro local do corpo");
        ...
        txtE.setText(" Jogar álcool e aplicar torniquetes");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questD7r.jpg")));
                ...
                frmDificil8 D8 = new frmDificil8();
                jDesktopPane1.add(D8);
                D8.setVisible(true);
