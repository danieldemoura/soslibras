 ...
 * @author DANIEL_VE160
 */
public class frmDificil9 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("O que deve ser feito ao encontrarmos uma vitima que sofreu afogamento?");
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questD9p.jpg"))); // NOI18N
        ...
        txtA.setText(" Fazer respiração boca a boca");
        ...
        txtB.setText(" Comprimir os pulmões para expelir água");
        ...
        txtC.setText(" Deita-la de bruços, com a cabeça pendendo de lado");
        ...
        txtD.setText(" Não fazer nada, deixa-la como esta");
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questD9r.jpg")));
                ...
                frmDificil10 D10 = new frmDificil10();
                jDesktopPane1.add(D10);
                D10.setVisible(true);
