 ...
 * @author DANIEL_VE160
 */
public class frmDificil4 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("Em um acidente observamos que o ferimento de uma vítima esguicha sangue no mesmo ritmo de sua pulsação Conclui-se que ocorreu o rompimento de");
        ...
        lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questD4p.jpg"))); // NOI18N
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if(selecao == true){
            if (passou == true) {
                lblVisualiza.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/questD4r.jpg")));
                ...
                frmDificil5 D5 = new frmDificil5();
                jDesktopPane1.add(D5);
                D5.setVisible(true);
